...
export function drawLandTile(
 ...
 //   ctx.rect(x + HALF_T, y + HALF_T, FULL_T, FULL_T);
 // });
...
function renderThreeCornersOneOwner(
 ...
 switch (tile.tile_case) {
  case 7: // empty corner top left
   draw_land_0111_ownership_x111(drawing, { x, y }, 0, styleForCorner(tile, 3));
   break;
  case 11: // empty corner top right
   draw_land_0111_ownership_x111(drawing, { x, y }, 1, styleForCorner(tile, 2));
   break;
  case 13: // empty corner bottom left
   draw_land_0111_ownership_x111(drawing, { x, y }, 3, styleForCorner(tile, 1));
   break;
  case 14: // empty corner bottom right
   draw_land_0111_ownership_x111(drawing, { x, y }, 2, styleForCorner(tile, 1));
   break;
  default:
   throw tile.tile_case + " shouldn't be a three corners case 😕";
 }
...
function renderTwoAdjacentOneOwner(
 ...
 switch (tile.tile_case) {
  case 3: // empty top
   draw_land_1100_ownership_11xx(drawing, { x, y }, 2, styleForCorner(tile, 2));
   break;
  case 5: // empty left side
   draw_land_1100_ownership_11xx(drawing, { x, y }, 1, styleForCorner(tile, 1));
   break;
  case 10: // empty right side
   draw_land_1100_ownership_11xx(drawing, { x, y }, 3, styleForCorner(tile, 0));
   break;
  case 12: // empty bottom
   draw_land_1100_ownership_11xx(drawing, { x, y }, 0, styleForCorner(tile, 0));
   break;
  default:
   throw tile.tile_case + " shouldn't be a three corners case 😕";
 }
...
function renderTwoOppositeOneOwner(
 ...
 switch (tile.tile_case) {
  case 6:
   draw_land_1001_ownership_1xx1(drawing, { x, y }, 1, styleForCorner(tile, 1));
   break;
  case 9:
   draw_land_1001_ownership_1xx1(drawing, { x, y }, 0, styleForCorner(tile, 0));
   break;
  default:
...
function renderSingleCornerOneOwner(
 ...
 switch (tile.tile_case) {
  case 1: // bottom right
   draw_land_1000_ownership_1xxx(drawing, { x, y }, 2, styleForCorner(tile, 3));
   break;
  case 2: // bottom left
   draw_land_1000_ownership_1xxx(drawing, { x, y }, 3, styleForCorner(tile, 2));
   break;
  case 4: // top right
   draw_land_1000_ownership_1xxx(drawing, { x, y }, 1, styleForCorner(tile, 1));
   break;
  case 8: // top left
   draw_land_1000_ownership_1xxx(drawing, { x, y }, 0, styleForCorner(tile, 0));
   break;
  default:
   throw tile.tile_case + " shouldn't be a two opp corners case 😕";
 }
